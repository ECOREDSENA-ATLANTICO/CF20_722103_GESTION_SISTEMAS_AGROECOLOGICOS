...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.cs
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-5
        figure
          img.img-t(src='@/assets/curso/images/tema5/img_1.png', alt='')
      .col-lg-7.mb-3
        ...
        .tarjeta.color-secundario-claro-sin-bordes.p-3.ps-4.bg_18.mb-4.mb-lg-0
          .row
            .col-md-2
              img.mt-3.img-t.m-auto(src='@/assets/curso/images/tema5/img_2.svg', alt='')
            .col-md-10
    ...
    TabsC.color-primario.mb-5
      ...
      .py-3.py-md-4(titulo="Alargamiento")
        .row
          .col-md-6
            figure
              img(src='@/assets/curso/images/tema5/img_4.png', alt='Texto que describa la imagen')
          .col-md-6.mb-4.mb-md-0
      ...
      .py-3.py-md-4(titulo="Enraizamiento")
        .row
          .col-md-6
            figure
              img(src='@/assets/curso/images/tema5/img_5.png', alt='Texto que describa la imagen')
          .col-md-6.mb-4.mb-md-0
      ...
      .py-3.py-md-4(titulo="Germinación")
        .row
          .col-md-6
            figure
              img(src='@/assets/curso/images/tema5/img_7.png', alt='Texto que describa la imagen')
          .col-md-6.mb-4.mb-md-0
            h4.mt-5 Germinación
      ...
      .py-3.py-md-4(titulo="Endurecimiento")
        .row
          .col-md-6
            figure
              img(src='@/assets/curso/images/tema5/img_10.png', alt='Texto que describa la imagen')
          .col-md-6.mb-4.mb-md-0
    ...
    .row.align-items-center.mb-4
      ...
      .col-lg-5.mb-4.mb-lg-0(data-aos="fade-left")
        figure
          img.img-t.m-auto(src='@/assets/curso/images/tema5/img_9.png', alt='')
        
    .row.align-items-center.mb-4
      .col-lg-3(data-aos="fade-right")
        figure
          img.img-t.m-auto(src='@/assets/curso/images/tema5/img_11.svg', alt='')
