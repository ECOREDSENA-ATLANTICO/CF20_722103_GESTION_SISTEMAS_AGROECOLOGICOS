...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.cs
    ...
    .row.mb-4
      ...
      .col-lg-6
        h3.mt-4(data-aos="fade-right") Importancia y responsabilidades
    ...
    .row.mb-4
      .col-auto
        img(src='@/assets/curso/images/tema5/img_7.svg' , alt='')
      .col-lg-6
        h3.mt-4(data-aos="fade-right") Análisis de peligros y puntos críticos de control
      ...
      .col-lg-7.mb-3
        ...
        .tarjeta.color-secundario-claro-sin-bordes.p-3.ps-4.bg_18.mb-4.mb-lg-0
          .row
            ...
            .col-md-10
              p.mt-3.p-1 Como indica Torres, E. G., Matos, A. R., Fernández, M. O., & Sánchez, O. M. (2005), el sistema HACCP mediante un acompañamiento, seguimiento detallado, con el empleo de técnicas y medidas de monitoreo constante se logra tener control del proceso y de los puntos críticos y peligros potenciales que afectan la inocuidad. 
